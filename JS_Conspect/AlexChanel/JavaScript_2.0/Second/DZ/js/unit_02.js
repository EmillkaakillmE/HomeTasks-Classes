...
/*
* Разница в том, что переменная 'e' имеет тип данных 'число', а переменная 'e1' - 'строку'.
* Все операнды с типом данных 'строка' преобразуют другие операнды в строки,
* если по отношению к этим другим операндам используется оператор '+'
* */
...
function t10() {
    document.querySelector('.out-10').textContent = document.querySelector('.i-10').value * 10;
}
...
function t11() {
    document.querySelector('.out-11').textContent = +document.querySelector('.i-11').value + 10;
}
